    ...
    Gas: TxGas<Env>,
{
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_big_int_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_big_int_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_big_int_ref_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_big_int_ref_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_big_int_ref_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_big_int_ref_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_big_uint_ref_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_big_uint_ref_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_big_uint_ref_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_big_uint_ref_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_big_uint_ref_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_big_uint_ref_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        a: Arg0,
        b: Arg1,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, NonZeroBigUint<Env::Api>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_non_zero_big_uint_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_non_zero_big_uint_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_non_zero_big_uint_ref_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_non_zero_big_uint_ref_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_non_zero_big_uint_ref_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_non_zero_big_uint_ref_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_non_zero_big_uint_ref_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_non_zero_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_non_zero_big_uint_ref_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_non_zero_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_big_int_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_big_int_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_big_int_ref_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_big_int_ref_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_big_int_ref_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_big_int_ref_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_big_uint_ref_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_big_uint_ref_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_big_uint_ref_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_big_uint_ref_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_big_uint_ref_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_big_uint_ref_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_non_zero_big_uint_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_non_zero_big_uint_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_non_zero_big_uint_ref_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_non_zero_big_uint_ref_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_non_zero_big_uint_ref_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_non_zero_big_uint_ref_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_non_zero_big_uint_ref_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_non_zero_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_non_zero_big_uint_ref_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_non_zero_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_big_int_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_big_int_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_big_int_ref_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_big_int_ref_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_big_int_ref_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_big_int_ref_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_big_uint_ref_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_big_uint_ref_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_big_uint_ref_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_big_uint_ref_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_big_uint_ref_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_big_uint_ref_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_non_zero_big_uint_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_non_zero_big_uint_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_non_zero_big_uint_ref_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_non_zero_big_uint_ref_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_non_zero_big_uint_ref_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_non_zero_big_uint_ref_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_non_zero_big_uint_ref_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_non_zero_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_non_zero_big_uint_ref_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_non_zero_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_big_int_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_big_int_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_big_int_ref_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_big_int_ref_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_big_int_ref_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_big_int_ref_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_big_uint_ref_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_big_uint_ref_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_big_uint_ref_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_big_uint_ref_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_big_uint_ref_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_big_uint_ref_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_non_zero_big_uint_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_non_zero_big_uint_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_non_zero_big_uint_ref_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_non_zero_big_uint_ref_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_non_zero_big_uint_ref_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_non_zero_big_uint_ref_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_non_zero_big_uint_ref_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_non_zero_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_non_zero_big_uint_ref_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_non_zero_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_big_int_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_big_int_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_big_int_ref_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_big_int_ref_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_big_int_ref_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_big_int_ref_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_big_uint_ref_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_big_uint_ref_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_big_uint_ref_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_big_uint_ref_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_big_uint_ref_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_big_uint_ref_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_non_zero_big_uint_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_non_zero_big_uint_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_non_zero_big_uint_ref_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_non_zero_big_uint_ref_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_non_zero_big_uint_ref_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_non_zero_big_uint_ref_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_non_zero_big_uint_ref_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_non_zero_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_non_zero_big_uint_ref_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_non_zero_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_assign_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_assign_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_assign_big_int_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_assign_big_int_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_assign_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_assign_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_assign_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_assign_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_assign_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_assign_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_assign_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_assign_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_assign_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_assign_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_assign_non_zero_big_uint_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_assign_non_zero_big_uint_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_assign_non_zero_big_uint_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_assign_non_zero_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_assign_non_zero_big_uint_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_assign_non_zero_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_assign_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_assign_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn add_assign_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("add_assign_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_assign_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_assign_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_assign_big_int_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_assign_big_int_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_assign_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_assign_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_assign_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_assign_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_assign_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_assign_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_assign_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_assign_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_assign_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_assign_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_assign_non_zero_big_uint_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_assign_non_zero_big_uint_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_assign_non_zero_big_uint_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_assign_non_zero_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_assign_non_zero_big_uint_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_assign_non_zero_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_assign_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_assign_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn sub_assign_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("sub_assign_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_assign_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_assign_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_assign_big_int_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_assign_big_int_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_assign_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_assign_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_assign_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_assign_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_assign_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_assign_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_assign_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_assign_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_assign_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_assign_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_assign_non_zero_big_uint_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_assign_non_zero_big_uint_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_assign_non_zero_big_uint_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_assign_non_zero_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_assign_non_zero_big_uint_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_assign_non_zero_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_assign_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_assign_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn mul_assign_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("mul_assign_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_assign_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_assign_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_assign_big_int_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_assign_big_int_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_assign_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_assign_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_assign_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_assign_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_assign_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_assign_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_assign_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_assign_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_assign_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_assign_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_assign_non_zero_big_uint_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_assign_non_zero_big_uint_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_assign_non_zero_big_uint_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_assign_non_zero_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_assign_non_zero_big_uint_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_assign_non_zero_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_assign_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_assign_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn div_assign_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("div_assign_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_assign_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_assign_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_assign_big_int_big_int_ref<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_assign_big_int_big_int_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_assign_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_assign_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_assign_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_assign_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_assign_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_assign_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_assign_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_assign_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_assign_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_assign_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_assign_non_zero_big_uint_non_zero_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_assign_non_zero_big_uint_non_zero_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_assign_non_zero_big_uint_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_assign_non_zero_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_assign_non_zero_big_uint_big_uint_ref<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_assign_non_zero_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_assign_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_assign_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn rem_assign_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("rem_assign_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_and_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_and_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_and_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_and_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_and_big_uint_ref_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_and_big_uint_ref_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_and_big_uint_ref_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_and_big_uint_ref_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_and_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_and_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_and_big_uint_ref_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_and_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_and_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_and_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_and_big_uint_ref_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_and_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_or_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_or_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_or_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_or_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_or_big_uint_ref_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_or_big_uint_ref_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_or_big_uint_ref_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_or_big_uint_ref_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_or_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_or_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_or_big_uint_ref_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_or_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_or_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_or_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_or_big_uint_ref_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_or_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_xor_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_xor_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_xor_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_xor_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_xor_big_uint_ref_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_xor_big_uint_ref_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_xor_big_uint_ref_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_xor_big_uint_ref_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_xor_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_xor_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_xor_big_uint_ref_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_xor_big_uint_ref_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_xor_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_xor_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_xor_big_uint_ref_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_xor_big_uint_ref_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_and_assign_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_and_assign_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_and_assign_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_and_assign_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_and_assign_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_and_assign_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_and_assign_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_and_assign_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_or_assign_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_or_assign_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_or_assign_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_or_assign_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_or_assign_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_or_assign_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_or_assign_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_or_assign_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_xor_assign_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_xor_assign_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_xor_assign_big_uint_big_uint_ref<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_xor_assign_big_uint_big_uint_ref")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_xor_assign_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_xor_assign_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn bit_xor_assign_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("bit_xor_assign_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn shr_big_uint_usize<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<usize>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("shr_big_uint_usize")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn shr_big_uint_ref_usize<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<usize>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("shr_big_uint_ref_usize")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn shl_big_uint_usize<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<usize>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("shl_big_uint_usize")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn shl_big_uint_ref_usize<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<usize>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("shl_big_uint_ref_usize")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn shr_assign_big_uint_usize<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<usize>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("shr_assign_big_uint_usize")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn shl_assign_big_uint_usize<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<usize>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("shl_assign_big_uint_usize")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_big_int_i32<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_big_int_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_big_int_i64<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_big_int_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_big_int_u32<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_big_int_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_big_int_u64<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_big_int_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_big_uint_i32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_big_uint_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_big_uint_i64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_big_uint_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_non_zero_big_uint_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_non_zero_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_non_zero_big_uint_i32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_non_zero_big_uint_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_non_zero_big_uint_i64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_non_zero_big_uint_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn eq_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("eq_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_big_int_i32<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_big_int_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_big_int_i64<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_big_int_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_big_int_u32<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_big_int_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_big_int_u64<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_big_int_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_big_uint_i32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_big_uint_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_big_uint_i64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_big_uint_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_non_zero_big_uint_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_non_zero_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_non_zero_big_uint_i32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_non_zero_big_uint_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_non_zero_big_uint_i64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_non_zero_big_uint_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn gt_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("gt_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_big_int_i32<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_big_int_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_big_int_i64<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_big_int_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_big_int_u32<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_big_int_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_big_int_u64<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_big_int_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_big_uint_i32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_big_uint_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_big_uint_i64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_big_uint_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_non_zero_big_uint_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_non_zero_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_non_zero_big_uint_i32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_non_zero_big_uint_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_non_zero_big_uint_i64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_non_zero_big_uint_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn ge_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("ge_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_big_int_i32<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_big_int_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_big_int_i64<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_big_int_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_big_int_u32<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_big_int_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_big_int_u64<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_big_int_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_big_uint_i32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_big_uint_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_big_uint_i64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_big_uint_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_non_zero_big_uint_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_non_zero_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_non_zero_big_uint_i32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_non_zero_big_uint_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_non_zero_big_uint_i64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_non_zero_big_uint_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn lt_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("lt_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_big_int_big_int<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<BigInt<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_big_int_big_int")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_big_int_i32<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_big_int_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_big_int_i64<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_big_int_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_big_int_u32<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_big_int_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_big_int_u64<
        Arg0: ProxyArg<BigInt<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_big_int_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_big_uint_big_uint<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_big_uint_i32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_big_uint_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_big_uint_i64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_big_uint_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_big_uint_u32<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_big_uint_u64<
        Arg0: ProxyArg<BigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_non_zero_big_uint_non_zero_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<NonZeroBigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_non_zero_big_uint_non_zero_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_non_zero_big_uint_big_uint<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_non_zero_big_uint_big_uint")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_non_zero_big_uint_i32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<i32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_non_zero_big_uint_i32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_non_zero_big_uint_i64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<i64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_non_zero_big_uint_i64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_non_zero_big_uint_u32<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u32>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_non_zero_big_uint_u32")
            .argument(&a)
            .argument(&b)
            .original_result()
    }

    pub fn le_non_zero_big_uint_u64<
        Arg0: ProxyArg<NonZeroBigUint<Env::Api>>,
        Arg1: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("le_non_zero_big_uint_u64")
            .argument(&a)
            .argument(&b)
            .original_result()
    }
    ...
    pub fn verify_custom_secp256k1_signature<
        ...
        Arg1: ProxyArg<ManagedBuffer<Env::Api>>,
        Arg2: ProxyArg<ManagedBuffer<Env::Api>>,
        Arg3: ProxyArg<multiversx_sc::types::crypto::message_hash_type::MessageHashType>,
    >(
        self,
        key: Arg0,
        message: Arg1,
    ...
    pub fn echo_non_zero_usize<
        Arg0: ProxyArg<core::num::nonzero::NonZero<usize>>,
    >(
        self,
        nz: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, core::num::nonzero::NonZero<usize>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("echo_non_zero_usize")
            .argument(&nz)
            .original_result()
    }
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("echo_non_zero_big_uint")
            .argument(&nzbu)
            .original_result()
    }
    ...
    pub fn echo_managed_vec_of_token_identifier<
        Arg0: ProxyArg<ManagedVec<Env::Api, EsdtTokenIdentifier<Env::Api>>>,
    >(
        self,
        mv: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ManagedVec<Env::Api, EsdtTokenIdentifier<Env::Api>>> {
        self.wrapped_tx
            .payment(NotPayable)
    ...
    pub fn echo_managed_async_result_empty<
        Arg0: ProxyArg<multiversx_sc::types::managed::multi_value::async_call_result_managed::ManagedAsyncCallResult<Env::Api, ()>>,
    >(
        self,
        a: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
    ...
    pub fn echo_varags_vec_with_counted<
        Arg0: ProxyArg<MultiValueEncoded<Env::Api, MultiValue2<ManagedBuffer<Env::Api>, multiversx_sc::types::managed::multi_value::multi_value_managed_vec_counted::MultiValueManagedVecCounted<Env::Api, usize>>>>,
    >(
        self,
        m: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, MultiValueEncoded<Env::Api, MultiValue2<ManagedBuffer<Env::Api>, multiversx_sc::types::managed::multi_value::multi_value_managed_vec_counted::MultiValueManagedVecCounted<Env::Api, usize>>>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("echo_varags_vec_with_counted")
            .argument(&m)
            .original_result()
    }

    pub fn echo_varags_vec_with_counted_pairs<
        Arg0: ProxyArg<MultiValueEncoded<Env::Api, MultiValue2<ManagedBuffer<Env::Api>, MultiValueEncoded<Env::Api, MultiValue2<usize, ManagedAddress<Env::Api>>>>>>,
    >(
        self,
        m: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, MultiValueEncoded<Env::Api, MultiValue2<ManagedBuffer<Env::Api>, MultiValueEncoded<Env::Api, MultiValue2<usize, ManagedAddress<Env::Api>>>>>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("echo_varags_vec_with_counted_pairs")
            .argument(&m)
            .original_result()
    }

    pub fn convert_varags_vec_with_counted_pairs_1<
        Arg0: ProxyArg<MultiValueEncoded<Env::Api, MultiValue3<ManagedAddress<Env::Api>, usize, MultiValueEncoded<Env::Api, MultiValue2<usize, usize>>>>>,
    >(
        self,
        address_number_pairs: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, MultiValueManagedVec<Env::Api, MultiValue3<ManagedAddress<Env::Api>, usize, multiversx_sc::types::managed::multi_value::multi_value_managed_vec_counted::MultiValueManagedVecCounted<Env::Api, multiversx_sc_codec::multi_types::multi_value_tuple::MultiValue2<usize, usize>>>>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("convert_varags_vec_with_counted_pairs_1")
            .argument(&address_number_pairs)
            .original_result()
    }

    pub fn convert_varags_vec_with_counted_pairs_2<
        Arg0: ProxyArg<MultiValueManagedVec<Env::Api, MultiValue3<ManagedAddress<Env::Api>, usize, multiversx_sc::types::managed::multi_value::multi_value_managed_vec_counted::MultiValueManagedVecCounted<Env::Api, multiversx_sc_codec::multi_types::multi_value_tuple::MultiValue2<usize, usize>>>>>,
    >(
        self,
        address_number_pairs: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, MultiValueEncoded<Env::Api, MultiValue3<ManagedAddress<Env::Api>, usize, MultiValueEncoded<Env::Api, MultiValue2<usize, usize>>>>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("convert_varags_vec_with_counted_pairs_2")
            .argument(&address_number_pairs)
            .original_result()
    }
    ...
    pub fn set_single_value_mapper_with_key<
        Arg0: ProxyArg<usize>,
        Arg1: ProxyArg<ManagedBuffer<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("set_single_value_mapper_with_key")
            .argument(&key)
            .argument(&value)
            .original_result()
    }
    ...
    pub fn unordered_set_mapper(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, MultiValueEncoded<Env::Api, u32>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("unordered_set_mapper")
            .original_result()
    }

    pub fn unordered_set_mapper_insert<
        Arg0: ProxyArg<u32>,
    >(
        self,
        item: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("unordered_set_mapper_insert")
            .argument(&item)
            .original_result()
    }

    pub fn unordered_set_mapper_contains<
        Arg0: ProxyArg<u32>,
    >(
        self,
        item: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("unordered_set_mapper_contains")
            .argument(&item)
            .original_result()
    }

    pub fn unordered_set_mapper_remove<
        Arg0: ProxyArg<u32>,
    >(
        self,
        item: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("unordered_set_mapper_remove")
            .argument(&item)
            .original_result()
    }
    ...
    >(
        self,
        how_many: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, MultiValueEncoded<Env::Api, core::num::nonzero::NonZero<usize>>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("non_zero_usize_iter")
            .argument(&how_many)
            .original_result()
    }
    ...
    pub fn get_value_from_address_with_keys<
        Arg0: ProxyArg<ManagedAddress<Env::Api>>,
        Arg1: ProxyArg<usize>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("get_value_from_address_with_keys")
            .argument(&address)
            .argument(&extra_key)
            .original_result()
    }

    pub fn address_to_id_mapper_get_id_from_address<
        Arg0: ProxyArg<ManagedAddress<Env::Api>>,
    >(
        self,
        address_arg: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("address_to_id_mapper_get_id_from_address")
            .argument(&address_arg)
            .original_result()
    }

    pub fn managed_decimal_addition<
        Arg0: ProxyArg<ManagedDecimal<Env::Api, ConstDecimals<U2>>>,
        Arg1: ProxyArg<ManagedDecimal<Env::Api, ConstDecimals<U2>>>,
    >(
        self,
        first: Arg0,
        second: Arg1,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ManagedDecimal<Env::Api, ConstDecimals<U2>>> {
        self.wrapped_tx
            .payment(NotPayable)
    ...
    pub fn managed_decimal_ln<
        Arg0: ProxyArg<ManagedDecimal<Env::Api, ConstDecimals<U9>>>,
    >(
        self,
        x: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ManagedDecimalSigned<Env::Api, ConstDecimals<9>>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("managed_decimal_ln")
            .argument(&x)
            .original_result()
    }

    pub fn managed_decimal_log2<
        Arg0: ProxyArg<ManagedDecimal<Env::Api, ConstDecimals<U9>>>,
    >(
        self,
        x: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("managed_decimal_log2")
            .argument(&x)
            .original_result()
    }

    pub fn managed_decimal_addition_var<
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("managed_decimal_addition_var")
            .argument(&first)
            .argument(&second)
            .original_result()
    }

    pub fn managed_decimal_subtraction_var<
        Arg0: ProxyArg<ManagedDecimal<Env::Api, usize>>,
        Arg1: ProxyArg<ManagedDecimal<Env::Api, usize>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("managed_decimal_subtraction_var")
            .argument(&first)
            .argument(&second)
            .original_result()
    }

    pub fn managed_decimal_eq_var<
        Arg0: ProxyArg<ManagedDecimal<Env::Api, usize>>,
        Arg1: ProxyArg<ManagedDecimal<Env::Api, usize>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("managed_decimal_eq_var")
            .argument(&first)
            .argument(&second)
            .original_result()
    }

    pub fn managed_decimal_ln_var<
        Arg0: ProxyArg<ManagedDecimal<Env::Api, usize>>,
    >(
        self,
        x: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("managed_decimal_ln_var")
            .argument(&x)
            .original_result()
    }

    pub fn managed_decimal_log2_var<
        Arg0: ProxyArg<ManagedDecimal<Env::Api, usize>>,
    >(
        self,
        x: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("managed_decimal_log2_var")
            .argument(&x)
            .original_result()
    }
