...
pub trait ReserveProofRegistry: mrv_common::MrvGovernanceModule {
    ...
    /// Enforces monotonic snapshot blocks and validates supply arithmetic.
    ...
    fn anchor_reserve_proof(
        ...
        let proof = ReserveProof {
            ...
            snapshot_block,
            anchored_at: self.blockchain().get_block_timestamp(),
        };
    ...
    /// Enforces monotonic snapshot blocks and validates issued >= retired.
